...
public class ControllerDocker {
    ...
    private ConnectionMySql configMySql = new ConnectionMySql();
    ...
    public ControllerDocker() {
        con = new JdbcTemplate(configMySql.getDataSource());
    }
    ...
    public String login(String usuarioFuncionario, String senhaFuncionario) {
        ...
        if (!tbFuncionario.isEmpty() && !login) {
            ...
            System.setProperty("idFuncionarioDocker", idFuncionario);
    ...
    public TbFuncionario getFuncionario() {
        ...
        Integer idFuncionario = Integer.valueOf(System.getProperty("idFuncionarioDocker"));
