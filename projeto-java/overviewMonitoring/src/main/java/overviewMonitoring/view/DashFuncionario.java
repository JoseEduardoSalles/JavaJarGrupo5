 ...
 */
package overviewmonitoring.view;
...
import overviewMonitoring.controller.ControllerDocker;
...
public class DashFuncionario extends javax.swing.JFrame {
    ...
    private TbFuncionario tbFuncionarioDocker;
    private TbComputador tbComputador;
    private TbComputador tbComputadorDocker;
    private Icons ic;
    ...
    public DashFuncionario() throws IOException {
        ...
        controllerDocker = new ControllerDocker();
        tbFuncionario = controller.getFuncionario();
        tbFuncionarioDocker = controllerDocker.getFuncionario();
        tbComputador = controller.getComputador();
        tbComputadorDocker = controllerDocker.getComputador();
...
//        lblThreads.setText(grupoDeProcessos.getTotalThreads().toString());
    ...
    public void printValueDesempenhoMaquina() {
        ...
        controllerDocker.insertDesempenhoMaquina(tbComputadorDocker.getIdTbComputador(), usoCPU, usoRAM);
    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addComponent(jPanel13, javax.swing.GroupLayout.PREFERRED_SIZE, 524, Short.MAX_VALUE)
        );
